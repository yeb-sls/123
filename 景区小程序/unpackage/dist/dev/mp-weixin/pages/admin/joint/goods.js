...
var _goods = _interopRequireDefault(__webpack_require__(/*! ./pages/admin/joint/goods.vue */ 839));
// @ts-ignore
...
/* harmony import */ var _goods_vue_vue_type_template_id_248269b0_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./goods.vue?vue&type=template&id=248269b0&scoped=true& */ 840);
/* harmony import */ var _goods_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./goods.vue?vue&type=script&lang=js& */ 842);
...
/* harmony import */ var _goods_vue_vue_type_style_index_0_id_248269b0_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./goods.vue?vue&type=style&index=0&id=248269b0&scoped=true&lang=css& */ 844);
            ...
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                if (res.result && res.result.data) {
                  ...
                  _this.goods = res.result.data.goods || [];
                }
                _context.next = 11;
                break;
              case 7:
                ...
                console.error('加载合坛法会代办物品配置失败:', _context.t0);
                uni.showToast({
                  title: '加载失败',
                  icon: 'none'
                });
        ...
        return _regenerator.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                if (!(!_this3.currentGood.name || !_this3.currentGood.price)) {
                  _context3.next = 3;
                  break;
                }
                uni.showToast({
              ...
              case 3:
                _context3.prev = 3;
                data = _objectSpread(_objectSpread({}, _this3.currentGood), {}, {
                  price: Number(_this3.currentGood.price) || 0,
                  stock: _this3.currentGood.stock ? Number(_this3.currentGood.stock) : null
                });
                if (_this3.isEdit && data._id) {
                  // 更新物品
                  updateData = _objectSpread({}, data);
                  delete updateData._id;
                  _this3.goods[_this3.editIndex] = _objectSpread(_objectSpread({}, _this3.goods[_this3.editIndex]), updateData);
                } else {
                  // 新增物品
                  delete data._id;
                  data._id = Date.now().toString(); // 临时ID
                  _this3.goods.push(data);
                }
              ...
              case 12:
                ...
                console.error('保存合坛法会代办物品失败:', _context3.t0);
                uni.showToast({
                  title: '保存失败',
                  icon: 'none'
                });
                        ...
                        while (1) {
                          switch (_context4.prev = _context4.next) {
                            case 0:
                              ...
                              _context4.prev = 1;
                              _this4.goods = _this4.goods.filter(function (good) {
                                return good._id !== id;
                              });
                              _context4.next = 5;
                              return uniCloud.callFunction({
                            ...
                            case 8:
                              ...
                              console.error('删除合坛法会代办物品失败:', _context4.t0);
                              uni.showToast({
                                title: '删除失败',
                                icon: 'none'
                              });
