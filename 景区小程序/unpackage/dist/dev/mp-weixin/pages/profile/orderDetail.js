...
var _orderDetail = _interopRequireDefault(__webpack_require__(/*! ./pages/profile/orderDetail.vue */ 193));
// @ts-ignore
...
/* harmony import */ var _orderDetail_vue_vue_type_template_id_fe06f320_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./orderDetail.vue?vue&type=template&id=fe06f320&scoped=true& */ 194);
/* harmony import */ var _orderDetail_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./orderDetail.vue?vue&type=script&lang=js& */ 196);
...
/* harmony import */ var _orderDetail_vue_vue_type_style_index_0_id_fe06f320_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./orderDetail.vue?vue&type=style&index=0&id=fe06f320&scoped=true&lang=css& */ 198);
...
var render = function () {
  ...
  var m0 = !!_vm.order ? _vm.getOrderType(_vm.order) : null
  var m1 = !!_vm.order ? _vm.getStatusText(_vm.order.status) : null
  var m2 = !!_vm.order ? _vm.getPaymentMethod(_vm.order.paymentMethod) : null
  var m3 = !!_vm.order ? _vm.formatDate(_vm.order.createTime) : null
  var m4 = !!_vm.order ? _vm.formatDate(_vm.order.payTime) : null
  var g0 = !!_vm.order
    ? _vm.order.applicants && _vm.order.applicants.length
    : null
  var g1 = !!_vm.order
    ? _vm.order.deceasedList && _vm.order.deceasedList.length
    : null
  var g2 = !!_vm.order ? _vm.order.goods && _vm.order.goods.length : null
  var g3 = !!_vm.order
    ? _vm.order.adminRemarks && _vm.order.adminRemarks.length
    : null
  var l0 =
    !!_vm.order && g3
      ? _vm.__map(_vm.order.adminRemarks, function (remark, index) {
          var $orig = _vm.__get_orig(remark)
          var m5 = _vm.formatDate(remark.time || remark.createTime)
          return {
            $orig: $orig,
            m5: m5,
          }
...
var _default = {
  ...
  methods: {
    ...
    getOrderType: function getOrderType(order) {
    ...
    getPaymentMethod: function getPaymentMethod(method) {
      var methodMap = {
        'wechat': '微信支付',
        'alipay': '支付宝',
        'bank': '银行转账'
